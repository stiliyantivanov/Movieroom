        ...
        <form method="post" action="/series/{{$series->id}}" enctype="multipart/form-data">
            ...
            <div class="flex justify-between mb-2">
                <div class="w-1/4 mr-2">
                    ...
                    <input type="string" id="name" name="name" value="{{$series->name}}"class="border-4 border-gray-600 rounded-lg"><br>
                    <label for="year_of_release" class="text-xl font-bold ml-5 mr-3">Year of release: </label><br>
                    <input type="int" id="year_of_release" name="year_of_release" value="{{$series->year_of_release}}"class="border-4 border-gray-600 rounded-lg"><br>
                ...
                <div class="w-1/4 mx-2">
                    ...
                    <textarea type="text" id="resume" name="resume" rows="4" cols="25" class="border-4 border-gray-600 rounded-lg">{{$series->resume}}</textarea><br>
                </div>
                <div class="w-1/4 mx-2">
            ...
            <div class="flex position-center justify-end">
                <button
                    type="submit"
                    action="/series/{{$series->id}}/update"
